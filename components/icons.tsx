...
export const IconStar = (props: IconProps) => (
  <Outline
    {...props}
    d="M12 2.5l2.69 5.46 6.03.88-4.36 4.25 1.03 6.02L12 16.9l-5.39 2.86 1.03-6.02-4.36-4.25 6.03-.88L12 2.5Z"
  />
);

export const IconContributor = (props: IconProps) => (
  <Outline
    {...props}
    d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.5 20.25a7.5 7.5 0 0 1 15 0M18 8.25v6m3-3h-6"
  />
);
